...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? ChatWidget() : InitialWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'MileStones',
          path: '/mileStones',
          builder: (context, params) => MileStonesWidget(),
        ),
        FFRoute(
          name: 'Challenge1',
          path: '/challenge1',
          builder: (context, params) => Challenge1Widget(),
        ),
        FFRoute(
          name: 'Challenge2',
          path: '/challenge2',
          builder: (context, params) => Challenge2Widget(),
        ),
        FFRoute(
          name: 'Motivation',
          path: '/motivation',
        ...
        FFRoute(
          name: 'Journel',
          path: '/journel',
          builder: (context, params) => JournelWidget(),
        ),
        FFRoute(
          name: 'initial',
          path: '/initial',
